...
export function MatchTab() {
  ...
  return (
    <div style={{ padding: 10, display: "flex", flexDirection: "column", gap: 6 }}>
      ...
      <button onClick={() => toggleSection("basic")} style={{ display: "flex", justifyContent: "space-between", alignItems: "center", padding: "2px 0", background: "transparent", color: "#ccc", border: "none", cursor: "pointer", fontSize: 11, textAlign: "left" }}>
      ...
      <button onClick={() => toggleSection("dims")} style={{ display: "flex", justifyContent: "space-between", alignItems: "center", padding: "2px 0", background: "transparent", color: "#ccc", border: "none", cursor: "pointer", fontSize: 11, textAlign: "left" }}>
      ...
      <div style={{ borderTop: "1px solid #444" }} />
      <button onClick={() => toggleSection("zones")} style={{ display: "flex", justifyContent: "space-between", alignItems: "center", padding: "2px 0", background: "transparent", color: "#ccc", border: "none", cursor: "pointer", fontSize: 11, textAlign: "left" }}>
