...
export const matchStyles = {
  ...
  sel: {
    ...
    background: "#1f1f1f url(\"data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='8' height='5' viewBox='0 0 8 5'><path d='M0 0l4 5 4-5z' fill='%23a0a0a0'/></svg>\") no-repeat right 5px center",
